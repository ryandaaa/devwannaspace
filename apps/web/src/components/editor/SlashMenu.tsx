...
interface SlashMenuProps {
  ...
  filterText: string;
  onClose: (explicitDismiss?: boolean) => void;
...
export const SLASH_MENU_ITEMS: SlashMenuItem[] = [
  ...
  { id: 'board',   title: 'Board',         description: 'Kanban board database',        iconName: 'Layout',      category: 'Structure', command: (e) => (e.chain().focus() as any).insertKanbanBoard().run() },
];
