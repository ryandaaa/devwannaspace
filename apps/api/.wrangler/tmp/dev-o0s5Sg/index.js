...
// .wrangler/tmp/bundle-dOnHLK/checked-fetch.js
...
// .wrangler/tmp/bundle-dOnHLK/strip-cf-connecting-ip-header.js
...
var Rt = T((Ah, Ls) => {
  ...
  }, "add"), Rr = /* @__PURE__ */ __name(class Rr {
    constructor(e) {
...
var eo = T((np, Xs) => {
  "use strict";
  p();
  var Yc = ge().EventEmitter, rp = (it(), O(nt)), Zc = rt(), An = ds(), Jc = Cs(), Xc = At(), el = Rt(), Js = qs(), tl = tt(), rl = En(), Cn = /* @__PURE__ */ __name(class Cn extends Yc {
    constructor(e) {
...
var io = T((op, no) => {
  ...
  var Rn = /* @__PURE__ */ __name(class Rn extends nl {
    constructor(e, t) {
...
_a121 = entityKind;
__publicField(IndexBuilderOn, _a121, "PgIndexBuilderOn");
var _a122;
...
_a122 = entityKind;
__publicField(IndexBuilder, _a122, "PgIndexBuilder");
var _a123;
var Index = class {
  config;
...
__name(Index, "Index");
_a123 = entityKind;
__publicField(Index, _a123, "PgIndex");
function index(name) {
...
_a140 = entityKind;
__publicField(PgDeleteBase, _a140, "PgDelete");
...
_a141 = entityKind;
__publicField(PgInsertBuilder, _a141, "PgInsertBuilder");
var _a142;
...
_a142 = entityKind;
__publicField(PgInsertBase, _a142, "PgInsert");
...
_a143 = entityKind;
__publicField(PgRefreshMaterializedView, _a143, "PgRefreshMaterializedView");
...
_a144 = entityKind;
__publicField(PgUpdateBuilder, _a144, "PgUpdateBuilder");
var _a145;
...
_a145 = entityKind;
__publicField(PgUpdateBase, _a145, "PgUpdate");
...
var _PgCountBuilder = class extends SQL {
  ...
  sql;
  token;
  [(_a146 = entityKind, Symbol.toStringTag)] = "PgCountBuilder";
  session;
...
__publicField(PgCountBuilder, _a146, "PgCountBuilder");
...
_a147 = entityKind;
__publicField(RelationalQueryBuilder, _a147, "PgRelationalQueryBuilder");
var _a148;
...
_a148 = entityKind;
__publicField(PgRelationalQuery, _a148, "PgRelationalQuery");
...
__name(PgRaw, "PgRaw");
_a149 = entityKind;
__publicField(PgRaw, _a149, "PgRaw");
...
_a150 = entityKind;
__publicField(PgDatabase, _a150, "PgDatabase");
...
__name(Cache, "Cache");
_a151 = entityKind;
__publicField(Cache, _a151, "Cache");
var _a152;
...
_a152 = entityKind;
__publicField(NoopCache, _a152, "NoopCache");
...
_a153 = entityKind;
__publicField(PgPreparedQuery, _a153, "PgPreparedQuery");
var _a154;
var PgSession = class {
  constructor(dialect) {
    this.dialect = dialect;
...
_a154 = entityKind;
__publicField(PgSession, _a154, "PgSession");
var _a155;
...
_a155 = entityKind;
__publicField(PgTransaction, _a155, "PgTransaction");
...
_a156 = entityKind;
__publicField(NeonHttpPreparedQuery, _a156, "NeonHttpPreparedQuery");
var _a157;
...
_a157 = entityKind;
__publicField(NeonHttpSession, _a157, "NeonHttpSession");
var _a158;
...
_a158 = entityKind;
__publicField(NeonTransaction, _a158, "NeonHttpTransaction");
...
_a159 = entityKind;
__publicField(NeonHttpDriver, _a159, "NeonHttpDriver");
...
_a160 = entityKind;
__publicField(NeonHttpDatabase, _a160, "NeonHttpDatabase");
...
var users = pgTable("users", {
  ...
  // We can use clerk or standard UUID
...
var issuesRelations = relations(issues, ({ one }) => ({
...
var getDb = /* @__PURE__ */ __name((c) => {
  const sql2 = cs(c.env.DATABASE_URL);
  return drizzle(sql2, { schema: schema_exports });
}, "getDb");
var parseDates = /* @__PURE__ */ __name((body) => {
  if (body.createdAt)
...
app.get("/api/projects", async (c) => {
  ...
  const allProjects = await db.query.projects.findMany({
    orderBy: (projects2, { desc: desc2 }) => [desc2(projects2.createdAt)]
  });
...
app.get("/api/issues", async (c) => {
  ...
  const allIssues = await db.query.issues.findMany({
    orderBy: (issues2, { desc: desc2 }) => [desc2(issues2.createdAt)]
  });
...
app.get("/api/pages", async (c) => {
  ...
  const allPages = await db.query.pages.findMany({
    orderBy: (pages2, { asc: asc2 }) => [asc2(pages2.position)]
  });
...
app.get("/api/notifications", async (c) => {
  ...
  const allNotifs = await db.query.notifications.findMany({
    orderBy: (notifs, { desc: desc2 }) => [desc2(notifs.createdAt)]
  });
...
// .wrangler/tmp/bundle-dOnHLK/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-dOnHLK/middleware-loader.entry.ts
